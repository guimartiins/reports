defmodule ReportsGeneratorTest do
  ...
  describe "build_from_many/1" do
    ...
    test "when a list is not provided, returns an error" do
      invalid_filename = "invalid list"

      response = ReportsGenerator.build_from_many(invalid_filename)

      expected_response = {:error, "A list must be provided!"}
      assert response == expected_response
    end
  end
  ...
  describe "fetch_higher_cost/2" do
    ...
    test "when the option is 'foods', returns the food that appeared the most" do
      file_name = "report_test.csv"
    ...
    test "when invalid options was provided, returns an error" do
      file_name = "report_test.csv"
